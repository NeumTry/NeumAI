---
title: 'MarqoSink'
description: 'MarqoSink enables seamless integration with Marqo vector database, supporting vector storage and similarity search for advanced data retrieval.'
---
